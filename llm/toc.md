...
- Normalizes only the outer title and root-list edge margins so the frame padding stays visually even; list markers, indentation, and spacing between items remain theme-controlled
