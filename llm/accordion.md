...
- The block emits no `FAQPage` JSON-LD. Google dropped FAQ rich results, so the schema was removed in 2.9.1 — do not add a `field_acf_accord_enable_faq_schema` key
