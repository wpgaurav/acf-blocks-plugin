...
if ( ! function_exists( 'md_star_rating_register_assets' ) ) {
    function md_star_rating_register_assets() {
        $dir = trailingslashit( get_stylesheet_directory() ) . 'blocks/star-rating-block/';
        $uri = trailingslashit( get_stylesheet_directory_uri() ) . 'blocks/star-rating-block/';
    ...
    md_star_rating_register_assets();
}

if ( ! function_exists( 'md_star_rating_handle_submission' ) ) {
    function md_star_rating_handle_submission() {
        check_ajax_referer( 'md_star_rating_submit', 'nonce' );
...
add_action( 'wp_ajax_md_star_rating_submit', 'md_star_rating_handle_submission' );
add_action( 'wp_ajax_nopriv_md_star_rating_submit', 'md_star_rating_handle_submission' );
