...
// Width class map
$width_class_map = [
    'narrow' => 'acf-thread-narrow',
    'medium' => 'acf-thread-medium',
    'wide' => 'acf-thread-wide',
    'full' => 'acf-thread-full'
];
...
<div id="<?php echo esc_attr($block_id); ?>" class="<?php echo esc_attr(implode(' ', $classes)); ?>">
    <?php if (!empty($thread_posts) && is_array($thread_posts)) : ?>
        <div class="acf-thread-container">
            ...
            ?>
                <div class="acf-thread-post<?php echo $is_last_post ? ' acf-last-post' : ''; ?>">
                    <?php if ($show_connector && !$is_last_post) : ?>
                        <div class="acf-thread-connector" style="background-color: <?php echo esc_attr($connector_color); ?>"></div>
                    <?php endif; ?>
                    ...
                    <div class="acf-post-content">
                        <div class="acf-post-header">
                            <?php if ($author_name) : ?>
                                <span class="acf-author-name"><?php echo esc_html($author_name); ?></span>
                            <?php endif; ?>

                            <?php if ($verified) : ?>
                                <span class="acf-verified-badge">
                            ...
                            <?php if ($author_handle) : ?>
                                <span class="acf-author-handle"><?php echo esc_html($author_handle); ?></span>
                            <?php endif; ?>
                        </div>
                        
                        <?php if ($content) : ?>
                            <div class="acf-post-text">
                                <?php
                                ...
                                $processed_content = preg_replace(
                                    ...
                                    [
                                        '<a href="#" class="acf-mention">@$1</a>',
                                        '<a href="#" class="acf-hashtag">#$1</a>',
                        ...
                        <?php if ($timestamp) : ?>
                            <div class="acf-post-time"><?php echo esc_html($timestamp); ?></div>
                        <?php endif; ?>
                        
                        <?php if ($show_engagement) : ?>
                            <div class="acf-post-engagement">
                                <div class="acf-engagement-item acf-replies">
                                ...
                                <div class="acf-engagement-item acf-reposts">
                                ...
                                <div class="acf-engagement-item acf-likes">
    ...
    <?php else : ?>
        <p class="acf-thread-placeholder">Add posts to create your thread.</p>
    <?php endif; ?>
</div>
